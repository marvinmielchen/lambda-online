...
function Tutorial() {
    ...
    return (
        <div className="tutorial">
            <h1>Lambo</h1>
            <p>
                Willkommen im Online Interpreter der Programmiersprache Lambo. Lambo ist eine minimalistische Sprache, die auf den Prinzipien des Lambda-Kalküls basiert. Der Lambda-Kalkül ist ein formales System in der mathematischen Logik und der theoretischen Informatik und bildet die Grundlage für funktionale Programmiersprachen. Durch die Nutzung von Funktionen als Obejkte erster Ordung ermöglicht der Lambda-Kalkül eine sehr abstrakte und klare Form der Programmierung.
            </p>
            <p>
