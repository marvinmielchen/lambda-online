...
\subsubsection{Syntax und Regeln im untypisierten Lambda-Kalkül}
...
\end{align*}
Ein Lambda Term is dabei eine der drei definierten Formen, wobei diese wiederum aus verschachtelten Lambda Termen bestehen können.
...
%ab hier altes Zeug
entweder eine Variable (z.B. $x, y, z, ...$), eine Abstraktion (z.B. $(\lambda x.x)$) oder eine Applikation (z.B. $()$).
