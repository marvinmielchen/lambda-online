...
\subsubsection{Einfürhung in den Lambda-Kalkül}
...
\end{align*}
Ein Lambda Term is dabei entweder eine Variable (z.B. $x, y, z, ...$), eine Abstraktion (z.B. $\lambda x.x$) oder eine Applikation.
